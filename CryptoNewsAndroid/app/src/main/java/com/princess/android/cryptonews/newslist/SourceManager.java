...
public class SourceManager {
    ...
    private  static  ArrayList<Source> getDefaultSources(Context context){
        ...
        defaultSources.add(new Source.NewsSource(SOURCE_FIRST_NEWS, 100, preferenceUtils.getFirstTitle(), false));
        defaultSources.add(new Source.NewsSource(SOURCE_SECOND_NEWS, 100, preferenceUtils.getSecondTitle(), false));
        defaultSources.add(new Source.NewsSource(SOURCE_THIRD_NEWS, 100, preferenceUtils.getThirdTitle(), false));
        defaultSources.add(new Source.NewsSource(SOURCE_FIRST_NEWS, 100, preferenceUtils.getFourthTitle(), false));
